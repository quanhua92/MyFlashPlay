...
export function MobileNavigation() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-900 border-t text-gray-900 dark::text-white border-gray-200 dark:border-gray-800 lg:hidden z-50 pb-safe">
